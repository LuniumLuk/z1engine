# editor-globals-source Specification

## Purpose
Where editor global render settings live and how they move between the editor settings file and scene
files: the editor/scene source toggle, editor-globals persistence, scene-owned global settings blocks,
and game-mode authority over globals.
## Requirements
