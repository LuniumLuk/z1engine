...
void EditorLayer::accept_payload(std::string const& data_type, std::function<void(void*)> callback) {
...
void EditorLayer::show_value(void* ptr, std::type_info const& type, std::string const& name, FieldInfo const& field, const EnumInfo* enum_info /*= nullptr*/) {
...
void EditorLayer::show_type_field(void* instance, FieldInfo const& field) {
...
void EditorLayer::show_properties() {
